...
Try {
	...
	[string]$appName = 'Banner PROD Desktop Shortcut'
	[string]$appVersion = ''
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '12/07/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		If (Test-Path -Path "C:\Users\Public\Desktop\Banner Prod.lnk" -PathType Leaf) { Copy-File -Path "$dirSupportFiles\*.lnk" -Destination "C:\Users\Public\Desktop"
        }
